...
//version 21/12/2015
// j'ai rajout� une partie pour la correction automatique des modules HV
// si la tension � corriger d�passe les 350V, il se cantonnera � 350V et basta

//version du 28/01/2016
// j'ai rajout� une fonction pour le num�ro de s�rie et pour l'activation et la d�sactivation du module HV
//pour la version step_3, l'activation et la d�sactivation du module HV est une fonction nulle
